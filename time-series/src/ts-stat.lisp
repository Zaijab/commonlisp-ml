...
(defparameter useco
    (time-series-data
     (read-data-from-file (clml.utility.data:fetch "https://mmaul.github.io/clml.data/sample/USeconomic.sexp"))))
(defparameter tokyo
    (time-series-data
...
(defparameter sunspot
    (time-series-data (read-data-from-file (clml.utility.data:fetch "https://mmaul.github.io/clml.data/sample/sunspot.sexp"))
                      :range '(1) :time-label 0))
(defparameter whard
    (time-series-data (read-data-from-file (clml.utility.data:fetch "https://mmaul.github.io/clml.data/sample/whard.sexp"))
                      :frequency 12))
(defparameter food
    (time-series-data (read-data-from-file (clml.utility.data:fetch "https://mmaul.github.io/clml.data/sample/bls-food.sexp"))
                      :range '(1) :time-label 0 :frequency 12))
(defparameter msi
    (time-series-data
     (read-data-from-file
      (clml.utility.data:fetch "https://mmaul.github.io/clml.data/sample/msi-access-stat/access-log-stat-0.sexp"))
