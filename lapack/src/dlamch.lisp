...
(let ((lieee1 nil) (lbeta 0) (lrnd nil) (lt$ 0) (first$ nil)
  ...
  (declare (type (f2cl-lib:integer4) lbeta)
           #-sbcl (type f2cl-lib:logical lieee1 lrnd first$)
           #-sbcl (type (integer) lt$)
           #+sbcl ((integer) lt$)
           #+sbcl ((f2cl-lib:integer4) lbeta)
           #+sbcl (f2cl-lib:logical lieee1 lrnd first$)
           #+sbcl (ignorable lt$ first$ lieee1 lrnd lbeta))
